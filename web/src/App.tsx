...
import {
  ...
  Monitor, Moon, Play, ShieldCheck, Siren, Sun, Upload,
} from 'lucide-react'
  ...
  return (
    <div className="app">
      <header className="topbar">
        ...
        {health && (
          /* .status-chip, not .hud-chip: the latter is tuned to sit on top of
             video and stays dark in both themes. */
          <span className="status-chip" title={`Detector: ${health.models.detector}`}>
            <span
